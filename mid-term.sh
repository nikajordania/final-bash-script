        ...
        if [ $? -eq 0 ]; then
            ...
            while git bisect next; do
                ...
                # Extract the first bad commit hash
                    ...
                    github_api_get_request "https://api.github.com/search/users?q=nika.zhordania.1@btu.edu.ge" $RESPONSE_PATH
                ...
                "
                        TITLE="First Bad Commit: $first_bad_commit"
                        BODY+="$first_bad_commit failed tests first bad commit"
